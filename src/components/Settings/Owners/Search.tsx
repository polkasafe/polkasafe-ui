...
const SearchOwner = () => {
	return (
		<div className='p-3 rounded-lg bg-bg-secondary flex items-center text-xs gap-x-2 md:gap-x-4 md:text-sm'>
			...
			<input placeholder='Search for owners by name or address' className='outline-none border-none min-w-[237px] bg-transparent flex items-center font-normal text-white' type="text" />
		</div>
	);
};
